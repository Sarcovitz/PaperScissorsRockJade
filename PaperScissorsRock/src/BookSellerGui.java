		...
		addButton.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				try {
					...
					String shippingPrice = shippingField.getText().trim();
					int sendPrice = Integer.parseInt(price) + Integer.parseInt(shippingPrice);
					myAgent.updateCatalogue(title, sendPrice );
					titleField.setText("");
					priceField.setText("");
